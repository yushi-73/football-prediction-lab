...
<head>
  <meta charset="UTF-8">
  <title>J1 2025 順位予測 | ver.1.5 xG導入テスト</title>
  <style>
    body {{
...
<body>
  <h1>J1 2025 順位予測 ver.1.5 xG導入テスト</h1>
  <div class="note">
    <p>
    ...
    <p>
      ...
      2025前半戦は「得点90% + 枠内シュート5% + xG5%」、2024前年はxGなしのため「得点90% + 総シュート10%」で攻守係数を計算しています。
