...
OUTPUT_GRID_CSV = BASE_DIR / "v15_elo_outcome_blend_grid_results.csv"
OUTPUT_BEST_CSV = BASE_DIR / "v15_elo_outcome_blend_best_prediction.csv"
OUTPUT_BEST_HTML = BASE_DIR / "v15_elo_outcome_blend_best_prediction.html"
...
def main():
    ...
    total = len(PREV_SETTING_CANDIDATES) * len(ELO_OUTCOME_WEIGHT_CANDIDATES)
    done = 0

    print("\n==============================")
    print("PREV設定候補 × Elo勝敗ブレンド グリッドサーチ開始")
    print("==============================")
    ...
    show_cols = [
        ...
        "elo_mode", "elo_outcome_weight", "mae",
    ...
    if RUN_FINAL_BEST and best_summary is not None:
        ...
        export_grid_html(
            ...
            OUTPUT_BEST_HTML,
            title=(
                "J1 2025 順位予測 v1.5候補 Elo勝敗ブレンド "
                f"{best_prev_setting_name}, outcome={best_elo_outcome_weight:.2f}"
            ),
        )
        ...
        print(final_prediction[[
            ...
            "elo_mode", "elo_outcome_weight_candidate", "effective_prev_weight",
