...
OUTPUT_GRID_CSV = BASE_DIR / "v15_prev040_decay0995_elo020_title_boost_tuning_results.csv"
OUTPUT_GRID_HTML = BASE_DIR / "v15_prev040_decay0995_elo020_title_boost_tuning_results.html"
OUTPUT_BEST_CSV = BASE_DIR / "v15_prev040_decay0995_elo020_title_boost_tuning_best_prediction.csv"
OUTPUT_BEST_HTML = BASE_DIR / "v15_prev040_decay0995_elo020_title_boost_tuning_best_prediction.html"
...
<body>
  ...
  <div class="note">
    <p>
      ...
      優勝ブースト、首位デバフ＋追走ブースト、残留ブースト併用を比較しています。
    </p>
    <p>
...
def main():
    ...
    print("\n==============================")
    print("優勝ブースト・首位デバフ/追走ブースト チューニング開始")
    print("==============================")
    ...
    export_pressure_grid_html(
        grid_df,
        OUTPUT_GRID_HTML,
        title="J1 2025 優勝ブースト補正 チューニング結果",
    )
